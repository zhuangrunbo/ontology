 ...
 * @author bazi
 */
public class MainPartExtractor4
{
...
//    }
    ...
    {	
		...
		for(CoreMap sentence: sentences) {
			...
			MainPartExtractor4 me = new MainPartExtractor4();
	      ...
	      new File("D:\\语义校正\\语料库\\新浪微博积极、消极、矛盾微博数据\\test.xlsx"));	//导出excel文件 //手动文件
	      FileOutputStream excel2file = new FileOutputStream(
	      new File("D:\\语义校正\\语料库\\新浪微博积极、消极、矛盾微博数据\\test2.xlsx"));	//只有句子的excel文件2
