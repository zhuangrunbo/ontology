...
//    }
    ...
    {	
    	...
    	FileRead(strings,"D:\\语义校正\\语料库\\test");
		...
		for(CoreMap sentence: sentences) {
	      ...
	      new File("D:\\语义校正\\语料库\\新浪微博积极、消极、矛盾微博数据\\test3.xlsx"));	//导出excel文件 //手动文件
	      FileOutputStream excel2file = new FileOutputStream(
	      new File("D:\\语义校正\\语料库\\新浪微博积极、消极、矛盾微博数据\\test4.xlsx"));	//只有句子的excel文件2
